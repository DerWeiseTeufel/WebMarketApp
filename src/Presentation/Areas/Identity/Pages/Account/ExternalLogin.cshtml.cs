...
namespace Presentation.Areas.Identity.Pages.Account
{
    ...
    public class ExternalLoginModel : PageModel
    {
        ...
        private Domain.Entities.User CreateUser()
        {
            try
            {
                return Activator.CreateInstance<Domain.Entities.User>();
            }
            catch
            {
        ...
        private IUserEmailStore<Domain.Entities.User> GetEmailStore()
        {
            if (!_userManager.SupportsUserEmail)
            {
                throw new NotSupportedException("The default UI requires a user store with email support.");
            }
            return (IUserEmailStore<Domain.Entities.User>)_userStore;
        }
    }
}
